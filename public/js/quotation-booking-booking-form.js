...
*/
	...
	function updateTotalAmount(){
		...
		var totalamount = parseFloat( propertysizeprice ) + parseFloat( bedroomsprice ) + parseFloat( bathroomsprice ) + parseFloat( bathtubsprice ) + parseFloat( sittingroomprice ) + parseFloat( diningroomprice ) + parseFloat( kitchenprice ) + parseFloat( ovenprice ) + parseFloat( kitchenitemsprice );
