 ...
 */
final class Version20190408194109 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quotation (id INT AUTO_INCREMENT NOT NULL, servicetype INT DEFAULT NULL, cleaningtype VARCHAR(255) DEFAULT NULL, propertyaddress VARCHAR(255) DEFAULT NULL, propertysize VARCHAR(255) DEFAULT NULL, bedrooms VARCHAR(255) DEFAULT NULL, bathrooms VARCHAR(255) DEFAULT NULL, bathtubs VARCHAR(255) DEFAULT NULL, sittingroom VARCHAR(255) DEFAULT NULL, diningroom TINYINT(1) DEFAULT NULL, kitchen VARCHAR(255) DEFAULT NULL, oven VARCHAR(255) DEFAULT NULL, frequencycleaning VARCHAR(255) DEFAULT NULL, preferredtime VARCHAR(255) DEFAULT NULL, priority VARCHAR(255) DEFAULT NULL, preferreddate DATETIME DEFAULT NULL, requirementdetails LONGTEXT DEFAULT NULL, additionalinfo LONGTEXT DEFAULT NULL, fname VARCHAR(255) DEFAULT NULL, lname VARCHAR(255) DEFAULT NULL, gender TINYINT(1) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, preferedcontact TINYINT(1) DEFAULT NULL, userfile VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
